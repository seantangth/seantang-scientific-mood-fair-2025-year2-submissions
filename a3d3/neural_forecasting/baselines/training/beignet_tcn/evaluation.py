"""
Beignet TCN Evaluation Script
===============================
Load a trained Beignet Public TCN checkpoint (h=256) and evaluate on the
validation set.
...
Usage:
    python evaluation.py \
        ...
        --checkpoint_path ./output/model_tcn_seed42.pth
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate a trained Beignet Public TCN on the validation set."
    )
    parser.add_argument(
    ...
    print(f"Model: TCNForecasterLarge(ch={n_ch}, feat={n_features}, "
