...
# ============================================================================
# v234b Config: v232c + TCN/TF 45/55 Beignet Public
# Beignet Public blend: 55% TCN + 45% TF (was 64/36)
...
TCN_TF_WEIGHT = 0.45  # optimized: 3-seed v213 TF is strong enough for more weight
